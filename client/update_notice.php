...
if ((isset($_GET['upd']))) {
    $user_id   = $_GET['upd'];
    $query = "SELECT * FROM notice_tble where user_id=$user_id ";
...
if ((isset($_POST['tmupdate']))) {
    ...
    $notice_tb = $_POST['notice_tb'];
    

    $query = "UPDATE `notice_tble` SET notice_tb='$notice_tb' where user_id =$user_id ";
    ...
    if ($fire){
        ...
        echo 'window.location = "notice.php";';
        echo '</script>';
      } else {
        echo '<script type="text/javascript">';
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="panel-body ">
                    ...
                    <h1 class="set1">&nbsp;NOTICE DATA</h1>
                    <p class="set my-2">Set Notice Data</p>
                    <form id="regForm1"  action="" method="post">
                        ...
                        <div class="row my-3">
                                    <div class="col-md-12">
                                    <label id="dynamic_field" class="b">Notice DATA: <span style="color:red">*</span></label>
                           <textarea value="<?php echo $row['notice_tb'] ?>" placeholder="notice_tb" class="form-control" 
                           name="notice_tb" rows="10"
                                required><?php echo $row['notice_tb'] ?></textarea>
