...
if ((isset($_POST['update']))) {
   ...
   $query = "UPDATE t_and_conditions SET terms_n_data='$terms_n_data' where user_id='$USER'";
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="panel-body ">
                    ...
                    <h1 class="set1">T & C. DATA</h1>
                    <p class="set my-2">&nbsp;&nbsp;Set Terms & Conditions Data</p>
                  ...
                  include '../conn/config.php';
                    $query = "SELECT * FROM t_and_conditions where user_id='$USER'";
                    ...
                    <form name="signup" id="signup" action="#" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <label id="dynamic_field" class="b">T & C: <span style="color:red">*</span></label>
                                    

                                        <!-- <input value=""type="text"  id="exampleFormControlTextarea1" class="form-control" name="Know_Book" id="" style="height: 100px;" >  -->
                                        <textarea name="terms_n_data" rows="10"  class="form-control">
                                         <?php echo $user['terms_n_data'] ?>
                                        </textarea>
