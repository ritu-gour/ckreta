...
if ((isset($_GET['upd']))) {
    $user_id = $_GET['upd'];
    $query = "SELECT * FROM exclusion_tab where user_id=$user_id";
...
if ((isset($_POST['update']))) {
    ...
    $query = "UPDATE `exclusion_tab` SET exclusion='$exclusion' where user_id=$user_id";
    ...
    if ($fire){
        ...
        echo 'window.location = "exclusion.php";';
        echo '</script>';
      } else {
        echo '<script type="text/javascript">';
                ...
                <div class="panel-body ">
                    ...
                    <form id="regForm1"  action="" method="post">
                        ...
                        <div class="row my-3">
                           ...
                           <textarea value="<?php echo $row['exclusion'] ?>" placeholder="" class="form-control" name="exclusion" rows="7"
