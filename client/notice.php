...
if ((isset($_POST['update']))) {
   ...
   $query = "UPDATE notice_tble SET notice_tb='$notice_tb' where user_id='$USER'";
            ...
            <section class="wrapper">
                <div class="panel-body ">
                  ...
                  include '../conn/config.php';
                    $query = "SELECT * FROM notice_tble where user_id='$USER'";
                    ...
                    <form name="signup" id="signup" action="#" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <label id="dynamic_field" class="b">NOTICE: <span style="color:red">*</span></label>
                                    

                                        <!-- <input value=""type="text"  id="exampleFormControlTextarea1" class="form-control" name="Know_Book" id="" style="height: 100px;" >  -->
                                        <textarea name="notice_tb" rows="10"  class="form-control">
                                         <?php echo $user['notice_tb'] ?>
                                        </textarea>
